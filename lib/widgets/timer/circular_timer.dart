...
import "package:med_agent_mobile/widgets/timer/circular_painter.dart";
...
class NeonCircularTimerState extends State<NeonCircularTimer>
  ...
  String get time {
    if (widget.isReverse && _controller!.isDismissed) {
      return _getTime(Duration(seconds: widget.duration));
    } else {
  ...
  String value(TextFormat format) {
    if (format == TextFormat.MM_SS) {
      return "min";
    } else if (format == TextFormat.SS) {
      return "sec";
    } else {
      return "";
    }
              ...
              child: AspectRatio(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    if (widget.titleInCircle != null || widget.isTimerTextShown)
                      Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            if (widget.titleInCircle != null)
                              Text(
                                widget.titleInCircle!,
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: value(
                                        widget.textFormat ?? TextFormat.SS,
                                      ),
                                      style: TextStyle(
                                        fontFamily:
                                            AppTextStyle.fontFamilyAlegreyaSans,
...
class CountDownController {
  NeonCircularTimerState state = NeonCircularTimerState();
