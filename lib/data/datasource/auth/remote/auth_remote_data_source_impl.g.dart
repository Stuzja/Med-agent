...
class _AuthDataSourceImpl implements AuthDataSourceImpl {
  ...
  @override
  Future<SignInResponseDto> refresh() async {
  ...
  @override
  Future<SignInResponseDto> signIn(SignInModelDto signInDto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<SignInResponseDto> signUp(SignUpModelDto signInDto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = signInDto;
